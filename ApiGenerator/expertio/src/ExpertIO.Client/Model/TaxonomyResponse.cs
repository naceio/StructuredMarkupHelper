...
namespace ExpertIO.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxonomyResponse :  IEquatable<TaxonomyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxonomyResponse" /> class.
        /// </summary>
        /// <param name="success">Operation completed successfully (true/false).</param>
        /// <param name="errors">Service errors.</param>
        /// <param name="data">data.</param>
        public TaxonomyResponse(bool success = default(bool), List<ServiceError> errors = default(List<ServiceError>), List<Taxonomy> data = default(List<Taxonomy>))
        {
        ...
        public List<Taxonomy> Data { get; set; }
        ...
        {
            return this.Equals(input as TaxonomyResponse);
        }

        /// <summary>
        /// Returns true if TaxonomyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxonomyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxonomyResponse input)
        {
            if (input == null)
                return false;
