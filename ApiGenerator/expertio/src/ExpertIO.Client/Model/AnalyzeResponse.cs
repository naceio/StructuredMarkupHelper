...
namespace ExpertIO.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnalyzeResponse :  IEquatable<AnalyzeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyzeResponse" /> class.
        /// </summary>
        /// <param name="success">Operation completed successfully (true/false).</param>
        /// <param name="errors">Service errors.</param>
        /// <param name="data">data.</param>
        public AnalyzeResponse(bool success = default(bool), List<ServiceError> errors = default(List<ServiceError>), AnalyzeDocument data = default(AnalyzeDocument))
        {
        ...
        {
            return this.Equals(input as AnalyzeResponse);
        }

        /// <summary>
        /// Returns true if AnalyzeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyzeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyzeResponse input)
        {
            if (input == null)
                return false;
