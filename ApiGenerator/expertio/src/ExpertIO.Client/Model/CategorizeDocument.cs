...
namespace ExpertIO.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CategorizeDocument :  IEquatable<CategorizeDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategorizeDocument" /> class.
        /// </summary>
        /// <param name="version">Service version.</param>
        /// <param name="language">Text language.</param>
        /// <param name="categories">Categories.</param>
        public CategorizeDocument(string version = default(string), string language = default(string), List<Category> categories = default(List<Category>))
        {
        ...
        {
            return this.Equals(input as CategorizeDocument);
        }

        /// <summary>
        /// Returns true if CategorizeDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of CategorizeDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategorizeDocument input)
        {
            if (input == null)
                return false;
