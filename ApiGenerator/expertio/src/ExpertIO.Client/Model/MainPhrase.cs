...
namespace ExpertIO.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MainPhrase :  IEquatable<MainPhrase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MainPhrase" /> class.
        /// </summary>
        /// <param name="value">Phrase text.</param>
        /// <param name="score">Score assigned to the phrase to represent its relevance.</param>
        /// <param name="positions">Positions of phrase occurrences.</param>
        public MainPhrase(string value = default(string), float score = default(float), List<DocumentPosition> positions = default(List<DocumentPosition>))
        {
            this.Value = value;
            this.Score = score;
        ...
        /// </summary>
        /// <value>Score assigned to the phrase to represent its relevance</value>
        ...
        /// </summary>
        /// <value>Positions of phrase occurrences</value>
        ...
        {
            return this.Equals(input as MainPhrase);
        }

        /// <summary>
        /// Returns true if MainPhrase instances are equal
        /// </summary>
        /// <param name="input">Instance of MainPhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MainPhrase input)
        {
            if (input == null)
                return false;
