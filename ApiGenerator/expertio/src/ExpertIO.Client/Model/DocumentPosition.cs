...
namespace ExpertIO.Client.Model
{
    ...
    public partial class DocumentPosition :  IEquatable<DocumentPosition>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="start">Zero-based position of the first character.</param>
        /// <param name="end">Zero-based position of the character after the last.</param>
        public DocumentPosition(long start = default(long), long end = default(long))
        {
            this.Start = start;
            this.End = end;
        }
        ...
        /// </summary>
        /// <value>Zero-based position of the first character</value>
        ...
        /// </summary>
        /// <value>Zero-based position of the character after the last</value>
