...
namespace ExpertIO.Client.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = ExpertIO.Client.Client.Configuration.Default;
            RestClient = new RestClient("https://nlapi.expert.ai/v2");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://nlapi.expert.ai/v2).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? ExpertIO.Client.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://nlapi.expert.ai/v2")
        {
