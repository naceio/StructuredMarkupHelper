...
${nuget_cmd} install src/ExpertIO.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ExpertIO.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ExpertIO.Client.dll \
-recurse:'src/ExpertIO.Client/*.cs' \
-doc:bin/ExpertIO.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ExpertIO.Client.dll was created successfully"
fi
